...
public abstract class AbstractFaultToleranceAnnotator implements FaultToleranceAnnotator {
    ...
    private void validateContext() {
        if (!context.hasClassAvailable(getRetryAnnotationName())) {
            throw new ProcessCodegenException("Initializing Kogito Fault Tolerance Annotator but no Fault Tolerance framework is available");
        }
    }
